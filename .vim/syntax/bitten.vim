...
syn keyword bittenKwShell   contained sh:exec sh:pipe
syn keyword bittenKwC       contained c:autoconf c:configure c:gcov c:make c:cppunit
syn keyword bittenKwJava    contained java:ant java:cobertura java:junit
syn keyword bittenKwPHP     contained php:phing php:phpunit php:coverage
syn keyword bittenKwPy      contained python:exec python:distutils python:unittest python:trace python:pylint
syn keyword bittenKwSVN     contained svn:checkout svn:export svn:update
syn keyword bittenKwXML     contained x:transform
