...
highlight CursorColumn  gui=None guibg=#222222
...
" NonText is the region below where you are editing that doesn't have text
" displayed
if version < 600
    " same as SpecialKey
    ...
    highlight NonText   gui=None guibg=#333333 guifg=LightSkyBlue
endif

" Command Area and left of ruler
highlight Normal        gui=None guibg=#333333 guifg=honeydew2
highlight Question      gui=bold  guifg=SeaGreen2 guibg=bg
highlight Search        gui=NONE guibg=LightSkyBlue4 guifg=NONE

" Stupid stuff like CNTRL+^
highlight SpecialKey    guibg=#AA0E99 guifg=#FFFFFF

" The little bar at the bottom
highlight StatusLine    gui=bold guibg=#898989 guifg=black
...
hi BeyondEighty cterm=bold ctermfg=white ctermbg=red guifg=red
hi PavlovMedia  cterm=bold ctermfg=magenta guifg=white guibg=#6B0B61
hi SubversionID cterm=bold ctermfg=magenta guifg=white guibg=#6B0B61
